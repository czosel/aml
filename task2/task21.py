...
param_distributions = {
    ...
    # OVA
    "ova__c1": [
        LinearSVC(class_weight="balanced", C=0.000891058, loss="squared_hinge")
    ],
    # "ova__c2": [SVC(class_weight="balanced", C=1.1547940567988086, gamma='scale', kernel="rbf")],
    "ova__c2": [
        LinearSVC(class_weight="balanced", loss="squared_hinge", C=0.000243486)
    ],
    "ova__c3": [
        LinearSVC(class_weight="balanced", loss="squared_hinge", C=0.000243486)
    ],
    "ova__c_tie": [
        OVOClassifier(
            c1=LinearSVC(
                class_weight="balanced", C=0.0020053280137711875, loss="hinge"
            ),
            c2=SVC(class_weight="balanced", C=1.2781191419905644, kernel="rbf"),
            c3=LinearSVC(
                class_weight="balanced", loss="squared_hinge", C=0.0005165696988129459
            ),
        )
    ],
...
if export:
    ...
    filename = f"results/ova-{search.best_score_:.3f}.csv"
    np.savetxt(
        filename,
        out,
        fmt=["%1.1f", "%1.14f"],
