...
process(X).to_csv("features/RAWCache/train_X.csv", index=False)
np.savetxt("features/RAWCache/train_y.csv", y, delimiter=",")
process(X).to_csv("features/RAWCache/test_X.csv", index=False)
