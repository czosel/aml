...
X, X_test, y = pd.read_csv("features/LSTMCache/train_X.csv"), pd.read_csv("features/LSTMCache/test_X.csv", delimiter=","), np.loadtxt("features/LSTMCache/train_y.csv", delimiter=",")
...
if export:
    ...
    filename = f"features/LSTMCache/y_feat.csv"
    print(y_pred.shape)
    np.savetxt(
        filename,
        y_pred,
    ...
    filename = f"features/LSTMCache/y_test.csv"
